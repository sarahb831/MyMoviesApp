...
// Main component
var myMoviesApplicaiton =
/*#__PURE__*/
function (_React$Component) {
  _inherits(myMoviesApplicaiton, _React$Component);

  function myMoviesApplicaiton() {
    _classCallCheck(this, myMoviesApplicaiton);

    return _possibleConstructorReturn(this, _getPrototypeOf(myMoviesApplicaiton).apply(this, arguments));
  }

  _createClass(myMoviesApplicaiton, [{
    key: "render",
  ...
  return myMoviesApplicaiton;
}(_react.default.Component); //Finds root of app


var container = document.getElementsByClassName('app-container')[0]; //Instructs React to render your app in root DOM element
